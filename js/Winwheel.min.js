function Winwheel(a, b) {
  ...
  for (var c in defaultOptions)
    this[c] =
      null != a && "undefined" !== typeof a[c] ? a[c] : defaultOptions[c];
  if (null != a)
    for (c in a) "undefined" === typeof this[c] && (this[c] = a[c]);
  this.canvasId
  ...
  for (x = 1; x <= this.numSegments; x++)
    this.segments[x] =
      null != a && a.segments && "undefined" !== typeof a.segments[x - 1]
        ? new Segment(a.segments[x - 1])
        : new Segment();
  ...
  this.pointerGuide =
    null != a && a.pointerGuide && "undefined" !== typeof a.pointerGuide
      ...
      : new PointerGuide();
  if (1 == b) this.draw(this.clearTheCanvas);
  else if ("segmentImage" == this.drawMode)
    for (
      winwheelToDrawDuringAnimation = this, winhweelAlreadyDrawn = !1, y = 1;
      y <= this.numSegments;
      y++
    )
  ...
  if (this.ctx)
    for (x = 1; x <= this.numSegments; x++) {
      ...
      if (seg.text) {
        ...
        var e =
          null !== seg.textAlignment ? seg.textAlignment : this.textAlignment;
        var q =
          null !== seg.textDirection ? seg.textDirection : this.textDirection;
        var f = null !== seg.textMargin ? seg.textMargin : this.textMargin;
        var l =
          null !== seg.textFillStyle ? seg.textFillStyle : this.textFillStyle;
        var m =
          null !== seg.textStrokeStyle
            ? seg.textStrokeStyle
            : this.textStrokeStyle;
        var d =
          null !== seg.textLineWidth ? seg.textLineWidth : this.textLineWidth;
        var g = "";
        null != c && (g += c + " ");
        null != b && (g += b + "px ");
        null != a && (g += a);
        ...
        for (i = 0; i < a.length; i++) {
          if ("reversed" == q)
            if ("horizontal" == k)
              ...
              this.ctx.translate(-this.centerX, -this.centerY);
              if ("outer" == e) var h = this.centerY + this.outerRadius - f;
              else "inner" == e && (h = this.centerY + this.innerRadius + f);
              g = b - b / 9;
              if ("outer" == e)
...
Winwheel.prototype.addSegment = function (a, b) {
  ...
  if ("undefined" !== typeof b) {
    ...
    c = b;
  } else (this.segments[this.numSegments] = newSegment), (c = this.numSegments);
  this.updateSegmentSizes();
...
Winwheel.prototype.getSegmentNumberAt = function (a, b) {
  ...
  if (c.x > this.centerX) {
    ...
    var e = "R";
  } else (k = this.centerX - c.x), (e = "L");
  if (c.y > this.centerY) {
    var q = c.y - this.centerY;
    var f = "B";
  } else (q = this.centerY - c.y), (f = "T");
  ...
  "T" == f && "R" == e
    ...
    ? (c = Math.round(l + 90))
    : "B" == f && "L" == e
    ? (c = Math.round(90 - l + 180))
    : "T" == f && "L" == e && (c = Math.round(l + 270));
  ...
  for (a = 1; a <= this.numSegments; a++)
    if (
      c >= this.segments[a].startAngle &&
      c <= this.segments[a].endAngle &&
      k >= this.innerRadius &&
      k <= this.outerRadius
    ) {
      e = a;
...
Winwheel.prototype.getRotationPosition = function () {
  ...
  } else -360 > a && ((b = Math.ceil(a / 360)), (a -= 360 * b)), (a = 360 + a);
  return a;
};
...
Winwheel.prototype.stopAnimation = function (a) {
  winwheelToDrawDuringAnimation &&
    (winwheelToDrawDuringAnimation.tween.kill(), winwheelStopAnimation(a));
  winwheelToDrawDuringAnimation = this;
};
...
function Pin(a) {
  ...
  if (null != a)
    for (b in a) "undefined" === typeof this[b] && (this[b] = a[b]);
}
...
function PointerGuide(a) {
  defaultOptions = { display: !1, strokeStyle: "red", lineWidth: 3 };
  for (var b in defaultOptions)
    this[b] =
      null != a && "undefined" !== typeof a[b] ? a[b] : defaultOptions[b];
}
...
function winwheelTriggerSound() {
  ...
  b != winwheelToDrawDuringAnimation._lastSoundTriggerNumber &&
